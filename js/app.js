...
if (document.querySelector('.users-work__slider')) {
   new Swiper('.users-work__slider', {
      observer: true,
      observeParents: true,
...
if (document.querySelector('.slider-main__body')) {
   new Swiper('.slider-main__body', {
      ...
      //Arrows
      navigation: {
         nextEl: '.slider-main .slider-button_next',
         prevEl: '.slider-main .slider-button_prev'
      }
   });
}

if (document.querySelector('.slider-trainers__body')) {
   new Swiper('.slider-trainers__body', {
      slidesPerView: 'auto',
      observer: true,
      observeParents: true,
      spaceBetween: 12,
      ...
      //Arrows
      navigation: {
         nextEl: '.slider-trainers .slider-button_next',
         prevEl: '.slider-trainers .slider-button_prev'
      }
   });
}
...
function menu_close() {
   ...
   social.classList.remove("_active");
}
//=================
//BodyLock
...
window.onload = function () {
   ...
   function documentActions(e) {
      ...
      if (window.innerWidth > 768 && isMobile.any()) {
         ...
         if (!targetElement.closest('.nav__item') && document.querySelectorAll('.nav__item._hover').length > 0) {
            _removeClasses(document.querySelectorAll('.nav__item._hover'), "_hover");
         }
      }
   }
}
